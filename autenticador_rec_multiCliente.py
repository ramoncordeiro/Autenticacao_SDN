...
class Autenticador():
    ...
    def server_receive_a0a1(ip):
        ...
        #return da
    def newClient(clientesocket,addr,ip,id_,get_p_q,recomputarMensagem,getSecret, lagrange, inversor,get_index_aut,get_cifra):
        while True:
            print 'Conectador por', cliente
            data = conexao.recv(4096)
            print ('PET ---------')#, repr(data))
    ...
    def server_socket_Controller(ip,id_,get_p_q,recomputarMensagem,getSecret, lagrange, inversor,get_index_aut,get_cifra,newClient):
        host = ip
        ...
        while True:
            conexao, cliente = tcp.accept()
            thread.start_new_thread(newClient,(conexao,cliente,ip,id_,get_p_q,recomputarMensagem,getSecret, lagrange, inversor,get_index_aut,get_cifra)) 
    ...
    #shamir(ide,get_p_q)
    #calc_a0a1()
    server_socket_Controller(ip,ide,get_p_q,recomputarMensagem,getSecret, lagrange, inversor,get_index_aut,get_cifra,newClient) 
