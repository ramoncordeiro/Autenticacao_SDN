...
class Autenticador():
    ...
    def recomputarMensagem(b,p,id,getSecret):
        ...
        #secret = getSecret(id)
        sec = getSecret(id)
        #print "Secret aut dentro func recomp Mens: ", sec
    ...
    def server_socket_TCP(self, ip, lagrange, shamir, get_p_q, a1, a2):
        ...
        while True:
            ...
            rec_mensagem = self.recomputarMensagem(self.getSecret(), b, p) #b,p,id,getSecret
    ...
    def server_socket_Controller(ip,id_,get_p_q,recomputarMensagem,getSecret, lagrange, inversor,get_index_aut,get_cifra):
        ...
        while True:
            ...
            m = recomputarMensagem(c,p,id_,getSecret)  #b,p,id,getSecret #b,p,id,getSecret
