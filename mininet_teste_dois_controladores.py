...
def myNet():
    ...
    h7 = net.addHost( 'h7', mac='01:00:00:00:07:00', ip='10.0.0.7' )

    # Create switches
    s1 = net.addSwitch( 's1', listenPort=6633, mac='00:00:00:00:00:09' )
    s2 = net.addSwitch( 's2', listenPort=6638, mac='00:00:09:09:09:09' )
    ...
    fl_ctrl = net.addController( 'c1', controller=RemoteController, ip=FL_CONTROLLER_IP, port=6638)
    ...
    h7.cmd('xterm -title "h7" -e python pox/pox/forwarding/cliente2_2.py &')
    #'''
